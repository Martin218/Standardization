report 50269 "Staff Promotions"
{
    // version TL2.0

    DefaultLayout = RDLC;
    RDLCLayout = 'Report\HR\Staff Promotions.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1; 50229)
        {
            ...
            column(Date_EmployeeMovement; Date)
            {
            }
    ...
    var
        ...
        HeaderText: Label 'Staff Promotions Report';
}
