report 50267 "Confirmed Employee Report"
{
    // version TL2.0

    DefaultLayout = RDLC;
    RDLCLayout = 'Report\HR\Confirmed Employee Report.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1; 5200)
        {
            ...
            column(ProbationEndDate_Employee; "Probation End Date")
            {
            }
            column(ProbationPeriod_Employee; "Probation Period")
            {
            }
            column(ConfirmationDismissalDate_Employee; "Confirmation/Dismissal Date")
            {
            }
    ...
    var
        ...
        Name: Text;
        HeaderTxt: Label 'Confirmed Employees Report';
}
