table 50412 "Requisition Header Line"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "Procurement Plan Line"."Line No" WHERE(Approved = FILTER('Yes'),
        ...
        field(25; "Quantity Returned"; Decimal)
        {
            ...
            begin
                ...
                ELSE
                    IF "Quantity Returned" < Quantity THEN BEGIN
                        IF NOT CONFIRM(LessQuantityConf) THEN BEGIN
                            "Quantity Returned" := 0;
    ...
    begin
        ...
        IF RequisitionHeader.GET("Requisition No.") THEN
    ...
    var
        ...
        LessQuantityConf: Label 'Please Note the Quantity returned is Less than the Quantity Requested. Do you wish to proceed?';
    ...
    begin
        ...
        IF ProcurementSetup."Purchase Req. From Plan" THEN
    ...
    begin
        ...
        ProcurementPlanLines.SETRANGE("Current Budget", "Procurement Plan");
        ProcurementPlanLines.SETRANGE("Line No", LineNo);
