page 50615 "Imprest Surrender Card"
{
    // version TL2.0
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Imprest To Surrender"; "Imprest To Surrender")
                {
                    ApplicationArea = All;
                }
                ...
                field("Surplus Amount"; "Surplus Amount")
                {
                    ApplicationArea = All;
                }
            }
            part("Imprest Surrender Lines"; "Imprest Surrender Lines")
            {
                ApplicationArea = All;
        ...
        area(creation)
        {
            ...
            action(Print)
            {
                ...
                begin
                    ...
                    REPORT.RUN(50445, TRUE, TRUE, Rec);
                end;
            }
            action(SendApprovalRequest)
            {
                ...
                begin
                    CashManagement.ImprestSurrenderRequiredFields(Rec);
            ...
            action(Post)
            {
                ...
                trigger OnAction();
                begin
                    CashManagement.PostingImprestSurrender(Rec);
                end;
            }
            action("Create Imprest Claim")
            {
                Image = CreateJobSalesCreditMemo;

                trigger OnAction();
                begin
                    CashManagement.CreateImprestClaim(Rec);
                end;
            }
        }
        area(processing)
    ...
    begin
        "Transaction Type" := "Transaction Type"::"Imprest Surrender";
    end;
