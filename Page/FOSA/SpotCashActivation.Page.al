page 50151 "SpotCash Activation"
{
    // version TL2.0
    ...
    layout
    {
        area(content)
        {
            ...
            part(SAS; "SpotCash Activation Subform")
            {
    ...
    actions
    {
        area(processing)
        {
            action(SendApprovalRequest)
            {
                ...
                begin
                    IF ApprovalsMgmt.CheckSpotCashActivationDeactivationApprovalPossible(Rec) THEN
                        ApprovalsMgmt.OnSendSpotCashActivationDeactivationForApproval(Rec);
                end;
            }
            action(CancelApprovalRequest)
            {
                ...
                begin
                    ApprovalsMgmt.OnCancelSpotCashActivationDeactivationApprovalRequest(Rec);
                end;
            }
        }
    }
