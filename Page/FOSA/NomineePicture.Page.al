    ...
    layout
    {
        area(content)
        {
            field(Picture; Picture)
            {
                ApplicationArea = All;
                ShowCaption = false;
                ToolTip = 'Specifies the Picture of the Member, for example, a logo.';
            }
        }
    }
        ...
        area(processing)
        {
            ...
            action(ExportFile)
            {
                ...
                begin
                    ...
                    ExportPath := TemporaryPath + "Application No." + Format(Picture.MediaId);
