page 50143 "SpotCash Application Card"
{
    // version TL2.0
    ...
    actions
    {
        area(processing)
        {
            action(SendApprovalRequest)
            {
                ...
                begin
                    IF ApprovalsMgmt.CheckSpotCashApplicationApprovalPossible(Rec) THEN begin
                        ApprovalsMgmt.OnSendSpotCashApplicationForApproval(Rec);
                        CurrPage.Close();
                    end;
                end;
            }
            action(CancelApprovalRequest)
            {
                ...
                begin
                    ApprovalsMgmt.OnCancelSpotCashApplicationApprovalRequest(Rec);
                end;
            }
            action(Approve)
            {
