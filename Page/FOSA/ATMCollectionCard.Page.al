page 50126 "ATM Collection Card"
{
    // version TL2.0
    ...
    actions
    {
        area(processing)
        {
            action(SendApprovalRequest)
            {
                ...
                begin
                    TESTFIELD("Card No.");
                    IF ApprovalsMgmt.CheckATMCollectionApprovalPossible(Rec) THEN
                        ApprovalsMgmt.OnSendATMCollectionForApproval(Rec);
                end;
            }
            action(CancelApprovalRequest)
            {
                ...
                begin
                    ApprovalsMgmt.OnCancelATMCollectionApprovalRequest(Rec);
    ...
    var
        ...
        Text000: Label 'ATM Card %1 has been issued successfully.';

        Text001: Label 'ATM Card %1 already exist.';
